...
$(function(){
	$(".viewBill").on("click",function(){
		...
		var obj = $(this);
		window.location.href=path+"/bill/queryBillById?billid="+ obj.attr("billid");
	});
	
	$(".modifyBill").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/bill/queryUpdateBillById?billid="+ obj.attr("billid");
	});
	$('#no').click(function () {
		cancleBtn();
	});
