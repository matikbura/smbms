...
$(function(){
	...
	$.ajax({
		type:"GET",//请求类型
		url:path+"/bill//getProvider",//请求的url
		data:{method:"list"},//请求参数
	...
	// 	}else{
	// 		validateTip(productDesc.next(),{"color":"red"},imgNo+" 编码不能为空，请重新输入",false);
	// 	}
	// }).on("focus",function(){
	// 	//显示友情提示
	// 	validateTip(productDesc.next(),{"color":"#666666"},"* 请输入订单编码",false);
	// }).focus();
